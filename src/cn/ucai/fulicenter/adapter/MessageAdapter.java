				...
				public void onError(int code, String error) {
					...
					activity.runOnUiThread(new Runnable() {
						public void run() {
							...
							holder.staus_iv.setVisibility(View.VISIBLE);
							Toast.makeText(activity,
									activity.getString(cn.ucai.fulicenter.R.string.send_fail) + activity.getString(cn.ucai.fulicenter.R.string.connect_failuer_toast), 0).show();
						}
					});
				}
			...
			public void run() {
				...
				if (message.status == EMMessage.Status.SUCCESS) {
				    ...
				    if(message.getError() == EMError.MESSAGE_SEND_INVALID_CONTENT){
				        Toast.makeText(activity, activity.getString(cn.ucai.fulicenter.R.string.send_fail) + activity.getString(cn.ucai.fulicenter.R.string.error_send_invalid_content), 0)
                        .show();
				    }else if(message.getError() == EMError.MESSAGE_SEND_NOT_IN_THE_GROUP){
				        Toast.makeText(activity, activity.getString(cn.ucai.fulicenter.R.string.send_fail) + activity.getString(cn.ucai.fulicenter.R.string.error_send_not_in_the_group), 0)
                        .show();
				    }else{
				        Toast.makeText(activity, activity.getString(cn.ucai.fulicenter.R.string.send_fail) + activity.getString(cn.ucai.fulicenter.R.string.connect_failuer_toast), 0)
                        .show();
				    }
				}
