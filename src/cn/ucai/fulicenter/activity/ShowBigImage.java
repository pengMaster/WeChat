...
public class ShowBigImage extends BaseActivity {
	...
	private int default_res = cn.ucai.fulicenter.R.drawable.default_image;
	...
	protected void onCreate(Bundle savedInstanceState) {
		setContentView(cn.ucai.fulicenter.R.layout.activity_show_big_image);
		super.onCreate(savedInstanceState);

		image = (PhotoView) findViewById(cn.ucai.fulicenter.R.id.image);
		loadLocalPb = (ProgressBar) findViewById(cn.ucai.fulicenter.R.id.pb_load_local);
		default_res = getIntent().getIntExtra("default_image", cn.ucai.fulicenter.R.drawable.default_avatar);
	...
	private void downloadImage(final String remoteFilePath, final Map<String, String> headers) {
		String str1 = getResources().getString(cn.ucai.fulicenter.R.string.Download_the_pictures);
		...
		final EMCallBack callback = new EMCallBack() {
			...
			public void onProgress(final int progress, String status) {
				...
				final String str2 = getResources().getString(cn.ucai.fulicenter.R.string.Download_the_pictures_new);
				runOnUiThread(new Runnable() {
					@Override
					public void run() {
