...
public class ContextMenu extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (type == EMMessage.Type.TXT.ordinal()) {
		    setContentView(cn.ucai.fulicenter.R.layout.context_menu_for_text);
		} else if (type == EMMessage.Type.LOCATION.ordinal()) {
		    setContentView(cn.ucai.fulicenter.R.layout.context_menu_for_location);
		} else if (type == EMMessage.Type.IMAGE.ordinal()) {
		    setContentView(cn.ucai.fulicenter.R.layout.context_menu_for_image);
		} else if (type == EMMessage.Type.VOICE.ordinal()) {
		    setContentView(cn.ucai.fulicenter.R.layout.context_menu_for_voice);
		} else if (type == EMMessage.Type.VIDEO.ordinal()) {
			setContentView(cn.ucai.fulicenter.R.layout.context_menu_for_video);
		}
