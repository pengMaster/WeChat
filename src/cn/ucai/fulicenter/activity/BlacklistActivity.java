...
public class BlacklistActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.fulicenter.R.layout.activity_black_list);
	...
	void removeOutBlacklist(final String tobeRemoveUser) {
	    ...
	    pd.setMessage(getString(cn.ucai.fulicenter.R.string.be_removing));
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            pd.dismiss();
                            Toast.makeText(getApplicationContext(), cn.ucai.fulicenter.R.string.Removed_from_the_failure, 0).show();
                        }
                    });
                }
            }
